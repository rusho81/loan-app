    ...
    <div class="bg-white shadow-md rounded-lg p-4">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                {{-- <img src="{{ asset($user->img) }}" alt="User Profile" class="w-16 h-16 rounded-full"> --}}
                <div>
        ...
        <div>
            <h3 class="text-xl font-semibold mb-2"><u>Loan Details</u></h3>
            ...
            <h4 class="text-xl font-semibold mb-2">Status: <u>{{ $loan->status }}</u> </h4>
