        ...
        <form>
            <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <input type="text" id="amount" name="amount" placeholder="Enter loan amount" oninput="calculateInstallment()" class="bg-gray-200 p-2 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:border-blue-300">
                </div>
                <div class="col-span-2 sm:col-span-1">
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <input type="text" id="installment_counts" name="amount" placeholder="Installment Count" class="bg-gray-200 p-2 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:border-blue-300"  oninput="calculateInstallment()">
                </div>
                <div class="col-span-2 sm:col-span-1">
